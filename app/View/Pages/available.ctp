    ...
    <div class="content_section bg_gray2 border_t_gray1" >
        <div class="full_content clearfix row_spacer">
            <div class="hm_columns content_block col-md-11 f_right row_spacer">
                        ...
                        <div class="blog_grid_block">
                            <div class="feature_inner">
                                <div class="feature_inner_corners">
                                    <a class="img_popup" href="http://placehold.it/1140x760">
                                        <img src="/images/Tullamore.jpg" alt="Clothes Vector">
                                        <span class="hm_plus_i"><i class="ico-plus10 hm_iii"></i></span>
                                    </a>
                                </div>
                            </div>
                            <div class="blog_grid_con">
                                <h6 class="title"><a href="#">Tullamore</a></h6>
                            </div>
                        </div>
                    </li>
