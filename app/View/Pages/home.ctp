        ...
        <div class="hm_main_content full_content clearfix">
            <div class="entry-content">
                ...
                <div class="it_section content_section white_section hide_text_shadow bg_color35">
                    <div class="hm_no_overlay row_spacer2" style="background-image: url(/img/bg20-1170x1170.png);background-size: auto;" data-speed="0.9"><span class="bg_overlay_con"></span>
                        <div class="section_content container">
                            ...
                            <div class="rows_container clearfix">
                                <div class="columns_con columns_normall clearfix">
                                    ...
                                    <!-- Column -->
                                    <div class="hm_columns show_xs show_sm show_md show_lg col-xs-12 col-sm-12 col-lg-6 col-md-6 f_left animated" data-animation="fadeInUp" data-animation-delay="100">
                                        <div class="hm_column_out column_spacer1">
                                            <div class="hm_column_con clearfix col_padd1 radius5">
                                                ...
                                                <div class="main_title title_boxed no_border no_line align_left tb_space25">
                                                    <h2 class="upper fs24 bold2">Why We Custom Build?</h2>
                                                </div>
                                    ...
                                    <!-- Column -->
                                    <div class="hm_columns show_xs show_sm show_md show_lg col-xs-12 col-sm-12 col-lg-6 col-md-6 f_left animated" data-animation="fadeInUp" data-animation-delay="300">
                                        <div class="hm_column_out column_spacer1">
                                            <div class="hm_column_con clearfix col_padd1 radius5 col_padd4 bg_color33">
                                                ...
                                                <ul class="list_icon circle_arrows colored clearfix">
                                                    <li>
                                                        <span class="list-arr"><i class="ico-arrow-right5"></i></span><a href="/pages/gallery">Tullamore</a>
                                                    </li>
                                                    <li>
                                                        <span class="list-arr"><i class="ico-arrow-right5"></i></span><a href="/pages/gallery">Tullamore</a>
                                                    </li>
