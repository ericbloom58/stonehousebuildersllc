        ...
        <div class="content clearfix">
           <div class="hm_columns content_block col-md-9 f_right row_spacer">
               <div class="content hm_blog_list clearfix">
                   ...
                   <div class="blog_grid_block clearfix">
                       <div class="feature_inner">
                           <div class="feature_inner_corners"> <a href="http://placehold.it/1140x760" class="img_popup"> <img src="http://placehold.it/600x375" alt="Best User Interface"> <span class="hm_plus_i"><i class="ico-plus10 hm_iii"></i></span> </a> </div>
                       </div>
                       <div class="blog_grid_con">
                   ...
                   <div class="blog_grid_block clearfix">
                       <div class="feature_inner">
                           <div class="feature_inner_corners"> <a href="http://placehold.it/1140x815" class="img_popup"> <img src="http://placehold.it/600x375" alt="Amazing standard post"> <span class="hm_plus_i"><i class="ico-plus10 hm_iii"></i></span> </a> </div>
                       </div>
                       <div class="blog_grid_con">
