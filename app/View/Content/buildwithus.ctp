                        ...
                        <div class="section_content container">
                            ...
                            <div class="rows_container clearfix">
                                <div class="columns_con columns_normall clearfix">
                                    ...
                                    <!-- Column -->
                                    <div class="hm_columns show_xs show_sm show_md show_lg col-md-6 f_left" id="buildingprocess">
                                        <div class="hm_column_out">
                                            <div class="hm_column_con clearfix col_padd1 column_spacer2">
                                                <div class="main_title title_boxed no_border no_line align_left">
                                                    <h2 class="bold1 fs20"><?= $buildingprocess['Content']['name']; ?></h2>
                                                </div>
                                                <div class="clear"></div>
                                                ...
                                                <div class="hm_text_sc">
                                                    <p>
                                                    <?= $buildingprocess['Content']['content']; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Column -->
                                    <div class="hm_columns show_xs show_sm show_md show_lg col-md-6 f_left" id="stonehousedifference">
                                        <div class="hm_column_out">
                                            <div class="hm_column_con clearfix col_padd1 column_spacer2">
                                                <div class="main_title title_boxed no_border no_line align_left">
                                                    <h2 class="bold1 fs20"><?= $stonehousedifference['Content']['name']; ?></h2>
                                                </div>
                                                <div class="clear"></div>
                                                <div class="hm_divider divi_border1 divi_left divi_i_c divi_mid default_boc default_bgc divi_space4 divi_hi2"></div>
                                                <div class="hm_text_sc">
                                                    <p>
                                                    <?= $stonehousedifference['Content']['content']; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Column -->
                                    <div class="hm_columns show_xs show_sm show_md show_lg col-md-12 f_left" id="buildonyourlot">
                                        <div class="hm_column_out">
                                            <div class="hm_column_con clearfix col_padd1 column_spacer2">
                                                <div class="main_title title_boxed no_border no_line align_left">
                                                    <h2 class="bold1 fs20"><?= $buildonyourlot['Content']['name']; ?></h2>
                                                </div>
                                                <div class="clear"></div>
                                                <div class="hm_divider divi_border1 divi_left divi_i_c divi_mid default_boc default_bgc divi_space4 divi_hi2"></div>
                                                <div class="hm_text_sc">
                                                    <p>
                                                    <?= $buildonyourlot['Content']['content']; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
