...
<head>
     ...
     <title>Stone House Builders | LLC</title>
...
<div id="main_wrapper">
    ...
    <header id="site_header">
        <div id="nav_bar">
            <div class="content"> 
                <!-- Logo -->
                <div id="logo" style="height: 200px; margin-top: 15px; margin-left:200px;"> 
                    <!--<a href="/" target="_self">--> 
                ...
                <div class="hm_columns col-md-4">
                    <div class="hm_column_con">
                        <div class="footer_row clearfix custom_text_with_image">
                            <h6 class="footer_title">Referral Gift Certificate Program</h6>
                    ...
                    <div class="hm_column_con">
                        <div class="footer_row clearfix contact_details_widget">
                            ...
                            <ul class="icon_details_list">
                                <li><i class="ico-map-marker2"></i>3314 Paper Mill Rd. Suite 202 Phoenix, MD 21131 </li>
                                <li><i class="ico-phone2"></i>(410)-628-2727</li>
                                <li><i class="ico-email"></i><a href="mailto:http://Support@site.com">info@stonehousebuildersllc.com</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
(function($){
	...
	$(document).ready(function() {
        if($("#rev_slider_35_1").revolution == undefined){
            revslider_showDoubleJqueryError("#rev_slider_35_1");
        }else{
            revapi35 = $("#rev_slider_35_1").show().revolution({
                sliderType:"standard",
                jsFileLocation:"/js/",
            ...
            newCall.callback = function() { 
                var proc = revapi35.revgetparallaxproc(),
                    fade = 1+proc,
                    scale = 1+(Math.abs(proc)/10);
            
                punchgs.TweenLite.set(revapi35.find('.slotholder, .rs-background-video-layer'),{opacity:fade,scale:scale});		
            }
            newCall.inmodule = "parallax";
            newCall.atposition = "start";
            
            revapi35.bind("revolution.slide.onloaded",function (e) {
                revapi35.revaddcallback(newCall);
            });
        }
	});
